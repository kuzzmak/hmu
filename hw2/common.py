...
class Player:
    ...
    def copy(self) -> Player:
        return Player(self.id, self.position, self.name, self.club, self.points, self.price)
...
class Solution:
    ...
    def copy(self) -> Solution:
        return Solution([p.copy() for p in self._players])
    ...
    def save(self, name: str = 'solution.txt'):
